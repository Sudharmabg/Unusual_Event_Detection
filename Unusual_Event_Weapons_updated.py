...
class YOLO(object):
    _defaults = {
            "model_path": 'C:/Users/Meghana/Desktop/UNUSUAL_EVENT_FINAL_Updated(4202020)/Unusual_Txt/trained_weights_final.h5',
           # "model_path": 'E:/P_2020/Dataset/OIDv4_ToolKit/Waste_Manage/trained_weights_final_waste.h5',
            ...
            "classes_path": 'C:/Users/Meghana/Desktop/UNUSUAL_EVENT_FINAL_Updated(4202020)/Unusual_Txt/4_CLASS_test_classes.txt',
            "score" : 0.3,
            "iou" : 0.45,
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class == 'Axe':
                print('AXE detected')
                data.write(str.encode('W'))

            if predicted_class == 'Knife':
                print('Knife detected')
                data.write(str.encode('W'))

            if predicted_class == 'Hammer':
